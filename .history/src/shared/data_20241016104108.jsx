...
export const rolePermissions = {
  admin: {
    ...
    booking: ['booking', 'ticket', 'users', 'courses', 'classes-of-course'],
    classes: ['announcement', 'classes', 'class-schedule', 'listOfTeacher', '']
  },
  teacher: {
  ...
  admin_sub: {
    ...
    student: ['student', 'student-profile', 'course-info'],
    booking: ['booking', 'ticket', 'courses', 'classes-of-course'],
