...
const Booking = () => {
  ...
  const handleCellClick = (classInfo, isAvailable) => {
    if (classInfo) {
      ...
      setSelectedClassInfo(classInfo) // Lưu lại thông tin lớp học
      setModalContent('ClassUpdateBookingModal') // Đặt nội dung modal
      setIsModalOpen(true)
    } else if (isAvailable) {
      ...
      setModalContent('ClassBookingModal') // Gán nội dung modal
      setIsModalOpen(true)
    } else {
    ...
    <>
      ...
      {modalContent === 'ClassUpdateBookingModal' && (
        <Modal show={isModalOpen}>
          <ModalText>Cập nhật thông tin lớp học này!</ModalText>
          <ButtonContainer>
