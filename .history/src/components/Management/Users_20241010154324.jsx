...
const StyledTable = styled.table`
  ...
  overflow-y: auto; /* Add vertical scrolling when content exceeds the max height */
...
const Users = () => {
  ...
  const handleModalClose = () => {
    setModalOpen(false)
    fetchUserData() // Fetch user data when the modal closes
  }
    ...
    <>
      ...
      <Container>
        <TableWrapper>
          ...
          <CreateUserModal
            isOpen={isModalOpen}
            onClose={handleModalClose} // Pass the fetch function to refresh data
