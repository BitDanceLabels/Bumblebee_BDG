...
const Booking = () => {
  ...
  const handleCellClick = (classInfo, isAvailable) => {
    if (classInfo) {
      ...
      // Giáo viên rảnh, mở modal combobox lớp học
      setClasses([
      ...
      setIsModalOpen(true) // Mở modal combobox
    } else {
      // Giáo viên không dạy giờ này
                ...
                <tr key={teacher.name}>
                  ...
                  {timeslots.map((time, index) => {
                    ...
                    if (classInfo) {
                      ...
                      // Màu nâu: Giáo viên rảnh nhưng không có lớp
                      return (
                        <TableCell
                          key={time}
                      ...
                      // Màu trắng: Giáo viên không đăng ký lịch dạy
                      return (
                        <TableCell
                          key={time}
                          style={{ backgroundColor: 'white' }} // Màu trắng
                          onClick={() => handleCellClick(null, isAvailable)} // Xử lý khi nhấp vào ô trắng
                        />
                      )
                    }
                  })}
