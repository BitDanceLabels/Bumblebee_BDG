...
const Users = () => {
  ...
  const handleUserCreated = () => {
    fetchUserData() // Refresh user data when a new user is created
  }
    ...
    <>
      ...
      <Container>
        <TableWrapper>
          ...
          <CreateUserModal
            isOpen={isModalOpen}
            onClose={handleModalClose} // Close modal without reloading data
            onUserCreated={handleUserCreated} // Reload user data when a new user is created
