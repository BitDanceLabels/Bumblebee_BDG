...
const Booking = () => {
  ...
  const [isGreenCell, setIsGreenCell] = useState(false)
  ...
  const handleCellClick = (classInfo, isAvailable, isGreen) => {
    if (classInfo) {
      // Giáo viên đã có lớp (màu xanh)
      ...
      setIsGreenCell(true) // Hiển thị combobox giáo viên
      setIsModalOpen(true)
    } else if (isAvailable) {
      // Giáo viên rảnh (màu nâu)
      setClasses([
      ...
      setIsGreenCell(false) // Không cần combobox giáo viên
      setIsModalOpen(true)
    } else {
      // Giáo viên không dạy giờ này (màu trắng)
  ...
  return (
    <>
      <ClassBookingModal
        ...
        classes={classes}
        teachers={teachers}
        isGreenCell={isGreenCell} // Kiểm tra xem có phải ô xanh không
      />
      <WrapperAll>
                    ...
                    if (classInfo) {
                      ...
                      return (
                        <TableCell
                          ...
                          onClick={() =>
                            handleCellClick(classInfo, isAvailable, true)
                          }
                        ></TableCell>
                      )
                    } else if (isAvailable) {
                      return (
                        <TableCell
                          ...
                          onClick={() =>
                            handleCellClick(null, isAvailable, false)
                          }
                        />
                      )
                    } else {
