          ...
          <tbody>
            <tr>
              <StickyTableCell rowSpan={10}>
                <VerticalText>Ca Sáng</VerticalText>
              </StickyTableCell>
            </tr>
            ...
            <tr>
              <StickyTableCell rowSpan={10}>
                <VerticalText>Ca Chiều</VerticalText>
              </StickyTableCell>
            </tr>
            {timeslots.slice(10, 20).map((time) => (
              <tr key={time}>
                <StickyTableCell>{time}</StickyTableCell>
                {days.map((day) => {
                  const isSelected = !!selectedCells[`${day}-${time}`]
            ...
            <tr>
              <StickyTableCell rowSpan={13}>
                <VerticalText>Ca Tối</VerticalText>
              </StickyTableCell>
            </tr>
            {timeslots.slice(20).map((time) => (
              <tr key={time}>
                <StickyTableCell>{time}</StickyTableCell>
                {days.map((day) => {
                  const isSelected = !!selectedCells[`${day}-${time}`]
