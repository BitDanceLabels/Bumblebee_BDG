...
const Navbar = ({ isHovered }) => {
  ...
  const renderParentItem = (parentItem, label, Icon, redirectTo = null) => {
  ...
  return (
    <NavbarWrapper isHovered={isHovered}>
      <nav className="navbar">
        <ul>
          {renderParentItem('classes', 'Dashboard', FaHome, '/announcement')}
          ...
          {renderParentItem('teacher', 'Teacher', GiTeacher, '/teacher')}
          <ul className={`sub-menu ${isHovered ? 'show' : 'hide'}`}>
