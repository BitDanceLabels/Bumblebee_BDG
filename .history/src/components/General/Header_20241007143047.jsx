...
const Header = () => {
  ...
  const [isDarkMode, setIsDarkMode] = useState(false) // State cho công tắc Mode
  ...
  const toggleDarkMode = () => {
    setIsDarkMode(!isDarkMode) // Thay đổi trạng thái công tắc
  }
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (modalRef.current && !modalRef.current.contains(event.target)) {
        setIsModalOpen(false) // Đóng modal nếu nhấn bên ngoài
      }
    }
              ...
              <ul>
                ...
                <li>
                  <SettingWrapper>
                    ...
                    <TextCustom>Role: Admin</TextCustom>
                  </SettingWrapper>
                </li>
                <li>
                  <SettingWrapper>
