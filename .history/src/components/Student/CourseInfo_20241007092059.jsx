...
const CourseInfo = () => {
  const [selectedMonth, setSelectedMonth] = useState('2024-10') // Chọn tháng mặc định
  const startDate = new Date(2024, 9, 1) // Ngày bắt đầu khóa học (tháng 10, 2024)
  const endDate = new Date(2024, 11, 31) // Ngày kết thúc khóa học (tháng 12, 2024)
