...
// Mỗi ô sẽ được chia thành các phần theo chiều dọc
const TableCell = styled.td`
  display: flex;
  flex-direction: row; /* Chia các phần theo chiều dọc */
  height: 70px;
  padding: 0;
  text-align: left;
  border: 1px solid #ddd;
...
// Chia mỗi ô thành 4 phần tương ứng với 15 phút
const QuarterDivider = styled.div`
  flex: 1; /* Mỗi phần chiếm 1/4 */
