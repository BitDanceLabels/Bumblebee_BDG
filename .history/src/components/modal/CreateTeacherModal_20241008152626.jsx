    ...
    >
      ...
      <Form>
        ...
        <FormGroup fullWidth>
          ...
          <Input id="role_group" name="role_group" value={formData.role_group} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
          <Label htmlFor="extension_number">Extension Number</Label>
          <Input id="extension_number" name="extension_number" value={formData.extension_number} onChange={handleChange} />
        </FormGroup>

        {/* Thông tin hợp đồng */}
        <FormGroup>
          <Label htmlFor="contract_signed_date">Contract Signed Date</Label>
          <Input type="date" id="contract_signed_date" name="contract_signed_date" value={formData.contract_signed_date} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
          <Label htmlFor="contract_expired_date">Contract Expired Date</Label>
          <Input type="date" id="contract_expired_date" name="contract_expired_date" value={formData.contract_expired_date} onChange={handleChange} />
        </FormGroup>

        {/* Thông tin kỹ năng */}
        <FormGroup>
          <Label htmlFor="skill">Skill</Label>
          <Input id="skill" name="skill" value={formData.skill} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
        ...
        <FormGroup>
          ...
          <Input id="teaching_certificate" name="teaching_certificate" value={formData.teaching_certificate} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
          <Label htmlFor="ielts_certificate">IELTS Certificate</Label>
          <Input id="ielts_certificate" name="ielts_certificate" value={formData.ielts_certificate} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
          <Label htmlFor="teaching_experience">Teaching Experience</Label>
          <Input id="teaching_experience" name="teaching_experience" value={formData.teaching_experience} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
          <Label htmlFor="suggested_class_level">Suggested Class Level</Label>
          <Input id="suggested_class_level" name="suggested_class_level" value={formData.suggested_class_level} onChange={handleChange} />
        </FormGroup>
      </Form>
      <ButtonWrapper>
        ...
        <ButtonSubmit type="button" onClick={onSubmit} style={{ marginTop: '10px' }}>
          Submit
        </ButtonSubmit>
      </ButtonWrapper>
    </Modal>
