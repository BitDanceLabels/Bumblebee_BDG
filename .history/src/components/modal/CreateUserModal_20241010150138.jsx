    ...
    try {
      const response = await fetch('http://127.0.0.1:8000/api/users/', {
        ...
        headers: {
          ...
          Authorization:
            'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJuaHV0cGhhbSIsImV4cCI6MTczMDk1MTA5NX0.TjliACbckGzJf2A0_L6ItR7w_DtMBA8NaIYaPNtpG-o' // Add your authorization token
        },
