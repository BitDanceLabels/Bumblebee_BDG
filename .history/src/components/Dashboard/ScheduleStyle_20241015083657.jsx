...
export const Table = styled.table`
  ...
  table-layout: fixed;
  font-size: 14px;
  border: 1px solid black; /* Đường viền tổng thể của bảng */
`
...
export const TableHeader = styled.th`
  ...
  background: #f4f4f4;
  padding: 10px;
  border: 1px solid black; /* Đường kẻ cho tiêu đề cột */
  white-space: nowrap;
  text-align: left;
  z-index: 1;
`
...
export const StickyTableHeader = styled(TableHeader)`
  ...
  z-index: 12;
  background: white;
  border: 1px solid black; /* Đường kẻ cho tiêu đề hàng */
`
...
export const StickyTableCell = styled.td`
  ...
  background: white;
  z-index: 12;
  border: 1px solid black; /* Đường kẻ dọc và ngang */
  white-space: nowrap;
  text-align: left;
  height: 70px;
`
