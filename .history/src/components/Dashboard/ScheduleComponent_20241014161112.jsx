            ...
            {filteredTeachers.map((teacher) => (
              <React.Fragment key={teacher.name}>
                <tr>
                  ...
                  {Object.values(teacher.schedule).map((info, index) => (
                      ...
                      <tr>
                        <td>
                          <ClassInfo
                            ...
                            width="120px" // Ví dụ width cố định cho tất cả các item, bạn có thể điều chỉnh
                            height="80px" // Ví dụ height cố định cho tất cả các item
                            top={`${index * 100}px`} // Giả sử bạn muốn thay đổi vị trí theo chỉ số index
                            left={`${index * 150}px`} // Tương tự cho vị trí ngang (left)
                          >
                            <div>{info.code}</div>
                            <div>{info.teacher}</div>
                            <div>{info.duration} phút</div>
