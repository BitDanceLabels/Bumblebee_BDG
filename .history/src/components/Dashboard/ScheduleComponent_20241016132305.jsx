...
const ScheduleComponent = () => {
  ...
  const [selectedClassInfo, setSelectedClassInfo] = useState(null) // Selected class info for modal
  ...
  const handleClassInfoClick = (classInfo) => {
    setSelectedClassInfo(classInfo) // Set the selected class info
                    ...
                    return (
                      <td key={index}>
                        <ClassInfo
                          ...
                          left={`${left}%`}
                          onClick={() => handleClassInfoClick(info)} // Click handler to show modal
                        >
                          <div>{info.code}</div>
