...
const TimeRangeComponentResolve = ({ timeRange, setTimeRange }) => {
...
const ScheduleComponent = () => {
  ...
  // Hàm lọc giáo viên dựa trên tên, tên lớp, học viên và khung giờ
    ...
    return (
      ...
      Object.keys(teacher.schedule).some((time) => {
        ...
        return (
          ...
          timeInHours >= timeRange[0] &&
          timeInHours <= timeRange[1]
        )
      })
    )
  })
