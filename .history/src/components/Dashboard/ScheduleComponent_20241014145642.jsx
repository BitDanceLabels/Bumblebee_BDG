              ...
              <tr key={teacher.name}>
                ...
                {timeslots.map((time, index) => {
                  ...
                  if (classInfo) {
                    ...
                    if (colSpanFraction < 1 && colSpanFraction > 0) {
                      // Trường hợp tô màu một phần của ô hiện tại và một phần của ô tiếp theo
                      return (
                        <TableCell key={time} colSpan={Math.ceil(colSpan)}>
                          <ClassInfo
                            ...
                            style={{
                              background: `linear-gradient(to right, ${getClassColor(
                                classInfo.type
                              )} ${colSpanFraction * 100}%, transparent ${
                                colSpanFraction * 100
                              }%)`
                            }}
                          >
