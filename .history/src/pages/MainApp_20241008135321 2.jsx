...
const NavbarWrapper = styled.nav`
  ...
  width: 60px; /* Đặt chiều rộng mặc định nhỏ */
  ...
  &:hover {
    ...
    transform: translateX(0); /* Trượt ra khi hover */
  }
`

const ContentWrapper = styled.div`
  margin-top: 60px;
  margin-left: 60px; /* Căn chỉnh theo kích thước mặc định của navbar */
  padding: 20px;
  flex-grow: 1;
  ...
  /* Khi hover navbar, content sẽ điều chỉnh theo */
  ${NavbarWrapper}:hover + & {
    margin-left: 250px;
  }
`
